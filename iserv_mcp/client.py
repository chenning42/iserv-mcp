"""Async HTTP client for iServ authentication and portal requests."""
...
class DownloadedFile:
    """Binary response returned by an authenticated iServ download."""
...
class IServClient:
    ...
    async def fetch_authenticated_file(
        self, href: str, max_bytes: int = 25 * 1024 * 1024
    ) -> DownloadedFile:
